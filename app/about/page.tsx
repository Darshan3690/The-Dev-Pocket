         ...
         <h2 id="hero-heading" className="text-3xl sm:text-md lg:text-md font-extrabold text-gray-800 leading-tight mb-3">What We Offer</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow cursor-pointer">
              <h3 className="text-xl font-semibold text-blue-600 mb-3">Personalized Roadmaps</h3>
            ...
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow cursor-pointer">
              <h3 className="text-xl font-semibold text-blue-600 mb-3">Curated Learning</h3>
              <p className="text-gray-700">
                Access high-quality tutorials, courses, and resources vetted by experts to help you stay ahead in your development journey.
              </p>
            </div>
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow cursor-pointer">
              <h3 className="text-xl font-semibold text-blue-600 mb-3">Job Search & Matching</h3>
              <p className="text-gray-700">
            ...
            <div className="p-6 bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow cursor-pointer">
              <h3 className="text-xl font-semibold text-blue-600 mb-3">Resume & Portfolio Tools</h3>
              <p className="text-gray-700">
