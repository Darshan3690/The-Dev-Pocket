...
import { FaPhoneAlt, FaEnvelope, FaRegCommentDots, FaGlobe, FaGithub, FaLinkedin, FaInstagram, FaDiscord } from "react-icons/fa";
...
>
  ...
  <div className="border-t border-gray-700 mt-10 pt-6 text-center text-sm text-gray-400">
    ...
    <div className="flex justify-center space-x-6">
      ...
      <Link href="https://bento.me/darshan3690" target="_blank" rel="noopener noreferrer" className="hover:text-blue-500">
        Contact
      </Link>
    </div>
  </div>
